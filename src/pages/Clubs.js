...
const Clubs = () => {
  ...
  // Replace your current clubs data with:
  const clubsData = [
    {
      "division": "CULTURE",
      "name": "INUO",
  ...
  const getFilterValue = (filter) => {
    switch(filter) {
      ...
      case 'Hobby': return 'HOBBY_EXHIBITION';
      case 'Religion': return 'RELIGION';
      default: return filter;
    }
  };

  const filteredClubs = selectedFilter === 'All' 
    ? clubsData 
    : clubsData.filter(club => club.division === getFilterValue(selectedFilter));
  ...
  return (
    <Container>
      ...
      <FilterContainer>
        ...
        <FilterChip 
          active={selectedFilter === 'Culture'} 
          onClick={() => setSelectedFilter('Culture')}
        >
          Culture
        </FilterChip>
        <FilterChip 
          active={selectedFilter === 'Sports'} 
          onClick={() => setSelectedFilter('Sports')}
        >
          Sports
        </FilterChip>
        <FilterChip 
          active={selectedFilter === 'Academic'} 
          onClick={() => setSelectedFilter('Academic')}
        >
          Academic
        </FilterChip>
        <FilterChip 
          active={selectedFilter === 'Hobby'} 
          onClick={() => setSelectedFilter('Hobby')}
        >
          Hobby & Exhibition
        </FilterChip>
        <FilterChip 
          active={selectedFilter === 'Religion'} 
          onClick={() => setSelectedFilter('Religion')}
        >
          Religion
        </FilterChip>
      </FilterContainer>
        ...
        {filteredClubs.map((club, index) => (
          ...
          >
            <ClubInfo>
              ...
              <ClubCategory>{club.division}</ClubCategory>
              <ClubDescription>{club.summary}</ClubDescription>
            </ClubInfo>
          </ClubCard>
        ))}
      </ClubsList>
